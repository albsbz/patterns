...
toDo.cards = [
  new Card('Implement renaming lists', 'Should be possible to change the name of the list'),
  new Card('Implement adding cards', 'Should be possible to create cards'),
  new Card('Implement removing of cards', 'Should be possible to remove card when button clicked'),
  new Card('Implement changing name of card', 'Should be possible to change the name of the card'),
  new Card('Implement changing description of card', 'Should be possible to change description of card'),
  new Card(
...
inProgress.cards = [new Card('Implement adding lists', 'Should be possible to create list')];
